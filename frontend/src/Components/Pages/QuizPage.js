...
function renderQuestions(){
    ...
    fetch('http://localhost:3000/questions?quiz=1') /* Ici ce sera à voir avec Ramtin plus tard, quand il va appuyer sur Démarer sur sa page ça va navigate vers ta page avec en paramètre l'ID du quiz que tu pourras récupérer */
